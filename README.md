# Project: Explanatory Data Visualization with Tableau 
## Survival on the Titanic

To see the project go to my [Tableau page](https://public.tableau.com/profile/mo2344#!/vizhome/P8_final/Story1)

For introduction see `P8.ipynb` file.

In addition you can download the Tableau file saved in `P8.twbx`.
...
This project requires [`Tableau software`](https://www.tableau.com/)and the following Python libraries 

### Code

The Tableau file saved in `P8.twbx`

### Run

Opent the `P8.twbx` in Tableau software enviroment.
